...
### cp <path where your tessdata_best files are>/Devanagari.traineddata   sanPlusMinus/Devanagari.traineddata
cp  ~/tessdata_best/script/Devanagari.traineddata   sanPlusMinus/Devanagari.traineddata
...
cp ~/langdata_lstm/san/san.punc sanPlusMinus/
cp ~/langdata_lstm/san/san.numbers sanPlusMinus/
cp ~/langdata_lstm/san/san.config sanPlusMinus/
cp ~/langdata_lstm/Devanagari.unicharset sanPlusMinus/
cp ~/langdata_lstm/Latin.unicharset sanPlusMinus/
cp ~/langdata_lstm/radical-stroke.txt sanPlusMinus/
...
cp  sanPlusMinus/unicharset  sanPlusMinus/my.unicharset  

#### create starter traineddata
mkdir -p sanPlusMinus/san
cp sanPlusMinus/san.config sanPlusMinus/san/
combine_lang_model \
...
### number of iterations depend on amount of training data available. Use 4000 for PlusMinus.
lstmtraining \
